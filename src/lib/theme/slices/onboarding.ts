...
export const onboardingCult: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every action earns points. Points determine your rank in the Inner Circle. Reach a new rank and the algorithm bestows a real, physical prize upon you.",
...
export const onboardingCorporate: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every step earns you points. Accumulate points to climb the rankings, unlock badges, and earn real prizes at each new level!",
...
export const onboardingAcademic: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Each phase contributes to your cumulative GPA. Higher standing unlocks advanced seminars, research opportunities, and real prizes at each new academic rank.",
...
export const onboardingStartup: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every action earns traction points. Climb the leaderboard, unlock perks, earn real prizes at each new level, and prove you're a 10x player.",
...
export const onboardingScifi: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Each completed phase increases your sync rating. Higher ratings unlock restricted data sectors, advanced interface protocols, and real prizes at each new rank.",
...
export const onboardingRetro: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "EACH COMMAND EARNS POINTS. ACCUMULATE POINTS TO INCREASE YOUR ACCESS LEVEL. PRIZES UNLOCKED AT EACH NEW LEVEL. HIGH SCORE TABLE UPDATED DAILY.",
...
export const onboardingNerdy: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every completed trial grants XP. Level up to unlock new skill trees, rare badges, real loot at each new level, and bragging rights in the guild hall.",
...
export const onboardingConsulting: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Each touchpoint generates value-add credits. Accumulate credits to move up the maturity model, unlock premium-tier thought leadership content, and earn real prizes at each new tier.",
...
export const onboardingNoir: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every move earns you points. Points push you up the ladder from Gumshoe to Commissioner. Make rank and the department sends you something real. Results get rewarded around here.",
...
export const onboardingPirate: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every action earns ye doubloons. Pile up enough and ye'll rise from Stowaway to Pirate King. Reach a new rank and real treasure be delivered to yer doorstep!",
...
export const onboardingMedieval: OnboardingSlice = {
  microcopy: {
    ...
    onboardingPointsBody: "Every rite performed earns favour with the Crown. Accumulate favour to ascend the court hierarchy, from Peasant to Sovereign. Each new title bestows a royal gift delivered to your estate.",
